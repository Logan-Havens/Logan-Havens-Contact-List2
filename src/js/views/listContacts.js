...
const listContacts = () => {
    ...
    return (
        ...
        <ul className="list-group">
            {store.listContacts.map((listContacts) => {
                return(
                    <div className="listContact" key={listContacts.id}>
                        <img className="contact-image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTS6hsBqWRnu1Q0813FIG_KgnUQRStGWlNKgQ&s" />
                        <div className="contact-text">
                            <div className="top-line">
                            <p className="contact-name">{listContacts.fullName}</p>
                            <Link to={"/editContacts/" + listContacts.id}>
